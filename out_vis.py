...
if __name__ == "__main__":
    ...
    parser.add_argument('--batchSize', default=1, type=int, help='Batch size to use for train/test sets')
    args = parser.parse_args()
    net = torch.load(args.model+".pt")
    ...
    test_loader = torch.utils.data.DataLoader(test_data, batch_size, num_workers=0)
